...
map.on('load', () => {
	...
	map.on('mousemove', (e) => {
		...
		if (showContourValue && features.length) {
...
var interactivityCheckbox = document.getElementById('interactivity');
interactivityCheckbox.checked = false;
interactivityCheckbox.addEventListener('change', function() {
	showContourValue = this.checked ? true : false;
	map.getCanvas().style.cursor = this.checked ? 'crosshair' : '';
});
